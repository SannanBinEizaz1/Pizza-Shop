...
//Admin Panel
	public void Admin()
	{
	System.out.println("Please enter the password to enter = ");
	password = adminPass.nextLine();
...
//Main menu function contains home screen
	...
	while(input!=4)
	{
			...
			default:
				System.out.println(
				"You have enetered an invalid Option Please Try gain \n Enter option here (e.g 1 2 ):- \n");
				input = in.nextInt();
				break;
...
//edit function to modify pizza details
	public void edit() {
		...
		case 1: {
			System.out
					.print("Please enter your Sause Option \n 1- with sause \n 2- no sause \n Please Enter Option = ");
			input = in.nextInt();
			if (input == 1) {
				pizza.setSause(true);
			} else if (input == 2) {
